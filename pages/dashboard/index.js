    ...
    <div>
      ...
      <div className="flex">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex">
            {state === "online" && <OnlineDashboard />}
            {state === "all" && <AllDashboard />}
            {state === "pending" && <PendingDashboard />}
            {state === "suggestion" && <SuggestionsDashboard />}
            {state === "blocked" && <BlockedDashboard />}
            {state === "add" && <AddFriendDashboard />}
